...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // Datos de prueba
        farmacia.push(new Medicamento("Acetaminofen", "LOT-001", 5));
        farmacia.push(new Medicamento("Ibuprofeno", "LOT-002", 7));
        farmacia.push(new Medicamento("Amoxicilina", "LOT-003", 25));
        farmacia.push(new Medicamento("Vitamina C", "LOT-004", 4));
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 3:
                    ...
                    Medicamento eliminado = farmacia.pop();

                    if (eliminado != null) {
                        System.out.println("Retirado: " + eliminado);
                    }
