...
public class App {
    ...
    Scanner scanner = new Scanner(System.in);
        ...
        callejon.push(new Camion("DEF-456", "María", 8));
        callejon.push(new Camion("GHI-789", "Pedro", 15));
        callejon.push(new Camion("JKL-321", "Luisa", 6));
        callejon.imprimir();
